...
"""Slide 6 (per-thread load): worker.simulate item counts and cumulative
time per thread, one representative timestep. debuglevel=2 dumps a
PER-THREAD block after every predict call.
...
def main():
    ...
    out_csv = common.DATA_DIR / "baseline_histogram.csv"
